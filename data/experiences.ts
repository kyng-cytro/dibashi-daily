...
export const experiences = [
  {
    ...
    imageAlt: "earlySTEMer development environment",
    achievements: [
  ...
  },
  {
    ...
    location: "Lagos, Nigeria",
    period: "AUG-OCT 2024",
    imageAlt: "Torrista Application Dashboard",
  ...
  {
    title: "Frontend Developer & Performance Specialist",
    company: "Blanche Aigle Communications",
    location: "Lagos, Nigeria",
    period: "JAN 2025",
    imageAlt: "Website performance optimization results",
    achievements: [
  ...
  {
    title: "Systems Developer & Technical Consultant",
    company: "F.O. Lanraj Enterprises",
    location: "Lagos, Nigeria",
    period: "APR 2024-PRESENT",
    imageAlt: "Internal business management systems",
    achievements: [
